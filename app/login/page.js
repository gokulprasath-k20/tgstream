  ...
  return (
    <div className="min-h-screen bg-[#05060f] flex items-center justify-center p-6 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-indigo-900/20 via-transparent to-transparent">
      <div className="w-full max-w-[440px] animate-slide-up">
        ...
        <div className="mt-10 flex items-center justify-center gap-6 text-gray-500 grayscale opacity-50">
           <div className="flex items-center gap-2 text-xs font-bold tracking-tighter"><Zap size={14}/> ULTRA FAST</div>
           <div className="flex items-center gap-2 text-xs font-bold tracking-tighter"><Lock size={14}/> SECURE AES</div>
        </div>
      </div>
    </div>
  );
