  ...
  return (
    <div className="min-h-screen bg-[#05060f] text-white flex overflow-hidden font-jakarta">
      ...
      <main className="flex-1 flex flex-col relative overflow-hidden">
        ...
        {/* Action Center */}
        <div className="flex-1 px-12 py-6 relative z-10 overflow-y-auto">
          ...
          <div className="max-w-4xl space-y-10">
            <div>
              ...
              <div className="flex gap-6">
                <div onClick={startNewMeeting} className="dashboard-card group w-48">
                ...
                <div onClick={joinMeeting} className="dashboard-card group w-48">
                ...
                <div onClick={() => router.push('/chat')} className="dashboard-card group w-48">
                  <div className="w-16 h-16 bg-indigo-600 rounded-3xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-xl shadow-indigo-600/20">
                    <MessageSquare size={32} />
                  </div>
                  <h3 className="font-bold">WhatsChat</h3>
                </div>
              </div>
            </div>
