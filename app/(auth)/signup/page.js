...
import { MonitorPlay, Mail, Lock, User, ArrowRight, Zap } from 'lucide-react';
...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-[#05060f] flex items-center justify-center p-6 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-indigo-900/20 via-transparent to-transparent">
      <div className="w-full max-w-[440px] animate-slide-up">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 font-medium">Join thousands of movie fans today</p>
        </div>
        ...
        <div className="card">
          <form onSubmit={handleSignUp} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" className="input pl-12" placeholder="PartyKing99" value={username} onChange={(e) => setUsername(e.target.value)} required />
              </div>
            </div>
          ...
          <div className="mt-8 text-center border-t border-white/5 pt-8">
            <p className="text-gray-400 text-sm">
              Already have an account? <Link href="/login" className="text-indigo-400 font-bold hover:text-indigo-300">Sign In instead</Link>
            </p>
          </div>
        </div>
      </div>
